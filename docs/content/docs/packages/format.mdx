---
title: Edge Runtime Format
description: The @edge-runtime/format package receives any JavaScript primitive or Object as input, returning the beauty string representation as output.
---
