---
title: Edge Runtime Jest Expect
description: The @edge-runtime/jest-expect package comes with useful Jest matchers to help testing Request and Response instances.
---
