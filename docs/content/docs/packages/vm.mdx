---
title: Edge Runtime VM
description: The @edge-runtime/vm package is the low level bindings for creating Web Standard isolated VM contexts under the same Vercel Edge Functions conditions.
---
